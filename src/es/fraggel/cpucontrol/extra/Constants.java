...
public class Constants {
	 ...
	 */
	public final static String LAUNCHER_ICON_STATUS_HIDE = "/system/etc/jiayucpu.hide";
	/**
	 * Special file (aimed to ROM developers) which determines if the launcher
	 * icon has to be shown (this overrides the LAUNCHER_ICON_STATUS_HIDE file).
	 */
	public final static String LAUNCHER_ICON_STATUS_SHOW = "/system/etc/jiayucpu.show";
	...
	public final static String DEVELOPER_MAIL = "spainjiayu@gmail.com";

	public final static String APPWIDGET_UPDATE = "es.fraggel.cpucontrol.APPWIDGET_UPDATE";
	...
	public final static String PREF_DEFAULT_SORT_METHOD = Stats.SortMethod.Frequency.name();
