...
public class CPUActivity extends Activity {
					...
					v.post(new Runnable() {
						public void run() {
							...
							SysUtils.setFrequenciesAndGovernor(min_freq, max_freq, governor, ioscheduler, changePermissions,
									CPUActivity.this, R.string.ok_updated_freqs, R.string.err_update_failed);
							if (Constants.DEBUG) {
	...
	protected void prepareAndSendEmail() {
		 ...
		 */
		String subject = "CPU Data [" + version + "]";
	...
	protected void displayChangeLog() {
		Toast.makeText(this, R.xml.changelog, R.drawable.ic_launcher).show();
	}
